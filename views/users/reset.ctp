<ul class="breadcrumb" style="margin: 0">
  ...
  <li>Restaurar Contrase&ntilde;a<span class="divider">/</span></li>
</ul>

<div align="center" style="height: 26px; padding-top: 5px; color: white; font-size: 18px; background: -webkit-linear-gradient(#A89587, #55473C); background: -moz-linear-gradient(#A89587, #55473C); background: -o-linear-gradient(#A89587, #55473C);"><strong>Restaurar Contrase&ntilde;a</strong></div>
<br />
...
<div class="users">
	...
	Introduzca su correo electr&oacute;nico para restaurar su contrase&ntilde;a.
		<?php
			echo $this->Form->input('email', array('label' => false, 'placeholder' => __('Email', true)));
