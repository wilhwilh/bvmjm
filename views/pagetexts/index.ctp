...
<div class="pagetexts index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $pagetext['Pagetext']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $pagetext['Pagetext']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $pagetext['Pagetext']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $pagetext['Pagetext']['title'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Nueva Página', true), array('action' => 'add')); ?></li>
	</ul>
</div>
